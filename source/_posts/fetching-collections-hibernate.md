...
[![ExampleDB_Diagram](/2013/10/17/fetching-collections-hibernate/ExampleDB_Diagram.jpg)](/2013/10/17/fetching-collections-hibernate/ExampleDB_Diagram.jpg)
...
You may download the example [here](/2013/10/17/fetching-collections-hibernate/Hibernate_FetchMode_CodeExample.zip). The zip contains a [Gradle project](http://www.gradle.org/). To run the example [install gradle ](http://www.gradle.org/installation) and run **gradle run** in the directory containing the build.gradle file.
